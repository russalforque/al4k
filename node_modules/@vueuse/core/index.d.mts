...
import { Ref, InjectionKey, ComputedRef, DefineComponent, Slot, ComponentObjectPropsOptions, TransitionGroupProps, MaybeRef, ComponentPublicInstance, MaybeRefOrGetter, WatchOptionsBase, Component, ShallowRef, WritableComputedRef, UnwrapRef, WatchOptions, UnwrapNestedRefs, App, WatchSource, ToRefs, StyleValue } from 'vue';
import { ConfigurableDeepRefs as ConfigurableDeepRefs$1 } from '@vueuse/core/_configurable';
...
interface UseCachedOptions<D extends boolean = true> extends ConfigurableDeepRefs$1<D>, WatchOptions {
}
...
declare function useDisplayMedia(options?: UseDisplayMediaOptions): {
    ...
    stop: () => void;
    enabled: vue.Ref<boolean, boolean> | vue.ShallowRef<boolean, boolean> | vue.WritableComputedRef<boolean, boolean> | vue.ShallowRef<true, true> | vue.ShallowRef<false, false>;
};
 ...
 * @param options
 */
declare function useEventSource<Events extends string[], Data = any>(url: MaybeRefOrGetter<string | URL | undefined>, events?: Events, options?: UseEventSourceOptions): UseEventSourceReturn<Events>;
...
declare function useUserMedia(options?: UseUserMediaOptions): {
    ...
    autoSwitch: Ref<boolean, boolean> | vue.ShallowRef<boolean, boolean> | vue.WritableComputedRef<boolean, boolean> | vue.ShallowRef<true, true> | vue.ShallowRef<false, false>;
};
